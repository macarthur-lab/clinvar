...
for i, line in enumerate(f):
    ...
    try:
        ...
        assert record['measureset_type'] in ["Variant", "Haplotype", "CompoundHeterozygote", "Phase unknown", "Distinct chromosomes", "Haplotype;CompoundHeterozygote", "Variant;gene-variant"], \
